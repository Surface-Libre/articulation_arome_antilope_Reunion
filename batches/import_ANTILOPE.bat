...
C:\Users\33751\Downloads\jython2.7.3\bin\jython.exe -J-Xmx2g -Djava.library.path=%VORTEX_HOME%\bin;%VORTEX_HOME%\bin\gdal C:\Users\33751\Desktop\artic_arome_antilope\batches\import_ANTILOPE.py
